        ...
        {/*Room Rating*/}
          ...
          {/*Room Highlights*/}
           <div className='flex flex-col md:flex-row md:justify-between mt-10'>
              ...
              {/*Room_Price*/}
              <p className='text-2xl font-medium'>Ksh.{room.pricePerMonth}/Month</p>
           </div>
           ...
           <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                  ...
                  <div className='flex flex-col'>
                   ...
                   <div className='flex flex-col'>
                    <label htmlFor="guests" className='font-medium'>RoomMates</label>
           ...
           <div className='mt-25 space-y-4'>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Hic vitae consequatur, magnam quisquam aut repellendus quia deleniti distinctio cum? Fuga tempora tempore non laborum totam dolor. Saepe nostrum voluptatum sunt.</p>
            </div>

            <div className='flex flex-col items-start gap-4'>
              {/*house hostedby*/}
              <div className='flex gap-4'>            
                   <img src={room.house.owner.image} alt=""  className='h-14 w-14 md:h-18 md:w-18 rounded-full'/>
                  <div>
                    <p className='text-lg md:text-xl'>Hosted by {room.house.name}</p>
